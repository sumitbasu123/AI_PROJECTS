...
async def _run_startup_preflight() -> None:
    ...
    if os.getenv("VIBE_TRADING_SKIP_PREFLIGHT", "").strip().lower() in {"1", "true", "yes"}:
        console.print("[dim]Startup preflight skipped by VIBE_TRADING_SKIP_PREFLIGHT.[/dim]")
        return
...
register_alpha_routes(app, require_auth, require_event_stream_auth)

from src.api.portfolio_routes import register_portfolio_routes  # noqa: E402
register_portfolio_routes(app, require_auth)
