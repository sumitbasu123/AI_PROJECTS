...
export const api = {
  ...
  getPortfolioConnectors: () => request<PortfolioConnectors>("/portfolio/connectors"),
  listPortfolioOrders: () => request<{ orders: PortfolioOrder[] }>("/portfolio/orders"),
  createPortfolioOrder: (body: PortfolioOrderRequest) =>
    request<PortfolioOrder>("/portfolio/orders", {
      method: "POST",
      body: JSON.stringify(body),
    }),
...
export interface PortfolioConnectors {
  connectors: PortfolioConnector[];
  live_ordering_enabled: false;
}

export interface PortfolioOrderRequest {
  symbol: string;
  side: "buy" | "sell";
  quantity: number;
  ...
  execution_mode: "simulated" | "connector_paper";
  connector_profile?: string;
  note?: string;
}

export interface PortfolioOrder extends PortfolioOrderRequest {
  id: string;
  created_at: string;
